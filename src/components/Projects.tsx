...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Cypress', 'Jest', 'Performance Testing', 'Accessibility Testing', 'Cross-browser Testing', 'Agile Testing'],
    ...
    },
    {
     // title: 'Maxxia Online Mobile Apps',
      ...
      technologies: ['Appium', 'Mobile Testing', 'Security Testing', 'API Testing', 'TestNG', 'Device Cloud Testing'],
    ...
    },
    {
      ...
      technologies: ['Selenium Grid', 'Load Testing', 'Payment Testing', 'Inventory Testing', 'JMeter', 'Cucumber'],
